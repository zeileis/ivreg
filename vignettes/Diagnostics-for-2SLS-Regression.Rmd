...
summary(seq)
```
By default, `summary()` prints the results of three "diagnostic" tests for 2SLS regression. These tests (which can be suppressed by setting the argument `tests=FALSE`) are not the focus of the vignette and so I'll comment on them only briefly:
