...
m.ivreg.w <- ivreg(Q ~ P + D, instruments = ~ P + D, weights=Q, data=Kmenta) # WLS
...
mw <- ivreg(Q ~ P + D, instruments = ~ D + F + A, weights=Q, data=Kmenta)
